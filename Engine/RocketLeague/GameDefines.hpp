...
struct FScriptDelegate
{
	...
	uint8_t UnknownData[0xC];			// 0x0000 (0x0C)
};
...
public:
	...
	uint8_t UnknownData00[0x30];		// Example of padding, you do not need to register this because offsets are all automatically calculated.
